...
Despite Xin's concerns, Sarah creates a `cocktails` project inside the `recipes`
...
Xin explains to Sarah how a nested repository is redundant and may cause confusion
